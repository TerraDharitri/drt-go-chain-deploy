...
import (
	...
	drtCommonFactory "github.com/TerraDharitri/drt-go-chain/common/factory"
	"github.com/TerraDharitri/drt-go-chain/config"
	"github.com/TerraDharitri/drt-go-chain/sharding"
	"github.com/urfave/cli"

	"github.com/TerraDharitri/drt-go-chain-deploy/check"
	"github.com/TerraDharitri/drt-go-chain-deploy/core"
	"github.com/TerraDharitri/drt-go-chain-deploy/generate/factory"
	"github.com/TerraDharitri/drt-go-chain-deploy/plugins"
)
...
`
	...
	richestAccount = cli.BoolFlag{
		...
		Usage: "if this flag is set, all the remaining balance will be credited to a new account. " +
			...
			"receive 1rEWA in order to complete some transactions (unstake, for instance)",
	}
...
func createPubKeyConverters() (drtCore.PubkeyConverter, drtCore.PubkeyConverter, error) {
	walletPubKeyConverter, err := drtCommonFactory.NewPubkeyConverter(config.PubkeyConfig{
		Length: 32,
	...
	validatorPubKeyConverter, err := drtCommonFactory.NewPubkeyConverter(config.PubkeyConfig{
		Length: 96,
